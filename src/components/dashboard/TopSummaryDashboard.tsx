...
import { useAdminDonationsSummary } from '@/lib/hook/useDonation'

const TopSummaryDashboard = () => {
  const { data: summary, isLoading } = useAdminDonationsSummary()
...
export default TopSummaryDashboard
