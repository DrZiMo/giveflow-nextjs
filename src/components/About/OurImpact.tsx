  ...
  return (
    <div className='mt-28'>
      <div className='flex flex-col gap-2 items-center text-center'>
        ...
        <p className='w-[90%] md:w-[60%] text-center text-lg text-muted-foreground'>
          Through the power of our platform and community, we&apos;ve achieved
          remarkable results
        </p>
      </div>

      <div className='boxes grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-10 text-center'>
        {boxes.map((box, index) => (
